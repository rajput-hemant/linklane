...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="focus:outline-none:pointer-events-none absolute top-4 right-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 data-[state=open]:bg-slate-100 dark:data-[state=open]:bg-slate-800">
        <X className="h-4 w-4" />
